...
**Materials**: If you have not already done so, please [download the lesson materials for this bootcamp](https://github.com/dbarneche/2014-10-31-USyd/raw/gh-pages/data/lessons.zip), unzip, then go to the directory `reproducible`, and open (double click) on the file `reproducible.Rproj` to open Rstudio.
...
[id2]: http://dbarneche.github.io/2014-10-31-USyd/lessons/90-reproducible/docs/knitr "Dalhousie example of html knitr report"
...
[id5]: https://raw.github.com/dbarneche/2014-10-31-USyd/gh-pages/lessons/90-reproducible.zip "Dalhousie example of original Rmd file used to generate knitr reports"
