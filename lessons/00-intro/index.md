...
- learn the basics of programming using the R language
- structure projects
- write functions
...
- Etherpad to share notes: [https://etherpad.mozilla.org/SWC-USyd](https://etherpad.mozilla.org/SWC-USyd) (check with sticky notes)
...
## Acknowledgements
This material was developed by Daniel Falster and Rich FitzJohn, incorporating examples and techniques (sticky notes, coding in pairs) from Greg Wilson. Modified by Diego Barneche.
