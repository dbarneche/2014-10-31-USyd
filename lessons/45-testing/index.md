...
**Extra lesson**: This topic was not covered during out bootcamp. The material below was taught by Dr. Gavin Simpson at the [SWC Bootcamp @ Dalhousie University](https://github.com/dbarneche/2014-07-14-Dalhousie/lessons/) (NS, Canada). 

**Materials**: If you have not already done so, please [download the lesson materials for this bootcamp](https://github.com/dbarneche/2014-10-31-USyd/raw/gh-pages/data/lessons.zip), unzip, then go to the directory `testing`, and open (double click) on the file `testing.Rproj` to open Rstudio.
